...
function myFunction(xml) {
    ...
    // IMPRIMIR ALT URGELL
    document.getElementById("urgell1").innerHTML = capital + ", " + nom;
    document.getElementById("urgell2").innerHTML = "<strong>Demà:</strong><br />" + prediccio;
    document.getElementById("urgell3").innerHTML = "<div class='temperatura'><div class='maxima'>" + prediccio4 + "ºC</div>&nbsp;<div class='minima'>" + prediccio5 + "ºC</div></div>";
    document.getElementById("urgell4").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ prediccio3 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ prediccio11 + "'/>";
    document.getElementById("urgell5").innerHTML = "<strong>Demà passat:</strong><br />" + prediccio6;
    document.getElementById("urgell6").innerHTML = "<div class='temperatura'><div class='maxima'>" + prediccio9 + "ºC</div>&nbsp;<div class='minima'>" + prediccio10 + "ºC</div></div>";
    document.getElementById("urgell7").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ prediccio8 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ prediccio12 + "'/>";
    document.getElementById("urgell8").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati + "<br />&nbsp;Tarda: " + nomprobcalatarda+"</div>";
    document.getElementById("urgell9").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati_d + "<br />&nbsp;Tarda: " + nomprobcalatarda_d +"</div>";
    document.getElementById("urgell10").innerHTML = "<strong>Precipitació</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati + "<br />&nbsp;Tarda: " + nomprobprecipitaciotarda +"</div>";
    document.getElementById("urgell11").innerHTML = "<strong>Precipitacio</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati_d + "<br />&nbsp;Tarda: " + nomprobprecipitaciotarda_d +"</div>";


    // IMPRIMIR ALTA RIBAGORÇA
    document.getElementById("altariba1").innerHTML = altariba2 + ", " + altariba;
    document.getElementById("altariba2").innerHTML = "<strong>Demà:</strong><br />" + altariba3;
    document.getElementById("altariba3").innerHTML = "<div class='temperatura'><div class='maxima'>" + altariba5 + "ºC</div>&nbsp;<div class='minima'>" + altariba6 + "ºC</div></div>";
    document.getElementById("altariba4").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ altariba4 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ altariba12 + "'/>";
    document.getElementById("altariba5").innerHTML = "<strong>Demà passat:</strong><br/>" + altariba7;
    document.getElementById("altariba6").innerHTML = "<div class='temperatura'><div class='maxima'>" + altariba9 + "ºC</div>&nbsp;<div class='minima'>" + altariba10 + "ºC</div></div> ";
    document.getElementById("altariba7").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ altariba8 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ altariba13 + "'/>";
    document.getElementById("altariba8").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati2 + "<br />&nbsp;Tarda: " + nomprobcalatarda2+"</div>";
    document.getElementById("altariba9").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati_d2 + "<br />&nbsp;Tarda: " + nomprobcalatarda_d2+"</div>";
    document.getElementById("altariba10").innerHTML = "<strong>Precipitació</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati2 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda2+"</div>";
    document.getElementById("altariba11").innerHTML = "<strong>Precipitacio</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati_d2 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda_d2+"</div>";


    // IMPRIMIR CERDANYA
    document.getElementById("cerdanya1").innerHTML = cerdanya2 + ", " + cerdanya;
    document.getElementById("cerdanya2").innerHTML = "<strong>Demà:</strong><br />" + cerdanya3;
    document.getElementById("cerdanya3").innerHTML = "<div class='temperatura'><div class='maxima'>" + cerdanya5 + "ºC</div>&nbsp;<div class='minima'>" + cerdanya6 + "ºC</div></div>";
    document.getElementById("cerdanya4").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ cerdanya4 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ cerdanya12 + "'/>";
    document.getElementById("cerdanya5").innerHTML = "<strong>Demà passat:</strong><br />" + cerdanya7;
    document.getElementById("cerdanya6").innerHTML = "<div class='temperatura'><div class='maxima'>" + cerdanya9 + "ºC</div>&nbsp;<div class='minima'>" + cerdanya10 + "ºC</div></div>";
    document.getElementById("cerdanya7").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ cerdanya8 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ cerdanya13 + "'/>";
    document.getElementById("cerdanya8").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati3 + "<br />&nbsp;Tarda: " +nomprobcalatarda3+"</div>";
    document.getElementById("cerdanya9").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati_d3 + "<br />&nbsp;Tarda: " +nomprobcalatarda_d3+"</div>";
    document.getElementById("cerdanya10").innerHTML = "<strong>Precipitació</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati3 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda3+"</div>";
    document.getElementById("cerdanya11").innerHTML = "<strong>Precipitacio</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati_d3 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda_d3+"</div>";


    // IMPRIMIR PALLARS
    document.getElementById("pallars1").innerHTML = pallars2 + ", " + pallars;
    document.getElementById("pallars2").innerHTML = "<strong>Demà:</strong><br />" + pallars3;
    document.getElementById("pallars3").innerHTML = "<div class='temperatura'><div class='maxima'>" + pallars5 + "ºC</div>&nbsp;<div class='minima'>" + pallars6 + "ºC</div></div>";
    document.getElementById("pallars4").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ pallars4 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ pallars12 + "'/>";
    document.getElementById("pallars5").innerHTML = "<strong>Demà passat:</strong><br />" +pallars7;
    document.getElementById("pallars6").innerHTML = "<div class='temperatura'><div class='maxima'>" + pallars9 + "ºC</div>&nbsp;<div class='minima'>" + pallars10 + "ºC</div></div>";
    document.getElementById("pallars7").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ pallars8 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ pallars13 + "'/>";
    document.getElementById("pallars8").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati4 + "<br />&nbsp;Tarda: " +nomprobcalatarda4+"</div>";
    document.getElementById("pallars9").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati_d4 + "<br />&nbsp;Tarda: " +nomprobcalatarda_d4+"</div>";
    document.getElementById("pallars10").innerHTML = "<strong>Precipitació</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati4 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda4+"</div>";
    document.getElementById("pallars11").innerHTML = "<strong>Precipitacio</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati_d4 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda_d4+"</div>";


    // IMPRIMIR VALL ARAN
    document.getElementById("vallaran1").innerHTML = aran2 + ", " + aran;
    document.getElementById("vallaran2").innerHTML = "<strong>Demà:</strong><br />" + aran3;
    document.getElementById("vallaran3").innerHTML = "<div class='temperatura'><div class='maxima'>" + aran5 + "ºC</div>&nbsp;<div class='minima'>" + aran6 + "ºC</div></div>";
    document.getElementById("vallaran4").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ aran4 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ aran12 + "'/>";
    document.getElementById("vallaran5").innerHTML = "<strong>Demà passat:</strong><br />" +aran7;
    document.getElementById("vallaran6").innerHTML = "<div class='temperatura'><div class='maxima'>" + aran9 + "ºC</div>&nbsp;<div class='minima'>" + aran10 + "ºC</div></div>";
    document.getElementById("vallaran7").innerHTML = "<img title='Matí' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ aran8 + "'/><img title='Tarda' src='https://static-m.meteo.cat/assets-w3/images/meteors/estatcel/"+ aran13 + "'/>";
    document.getElementById("vallaran8").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati5 + "<br />&nbsp;Tarda: " +nomprobcalatarda5+"</div>";
    document.getElementById("vallaran9").innerHTML = "<strong>Calamarsa</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobcalamati_d5 + "<br />&nbsp;Tarda: " +nomprobcalatarda_d5+"</div>";  
    document.getElementById("vallaran10").innerHTML = "<strong>Precipitació</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati5 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda5+"</div>";
    document.getElementById("vallaran11").innerHTML = "<strong>Precipitacio</strong><br /><br /><div class='pluges'>&nbsp;Matí: " + nomprobprecipitaciomati_d5 + "<br />&nbsp;Tarda: " +nomprobprecipitaciotarda_d5+"</div>";
